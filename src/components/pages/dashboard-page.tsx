...
import { useDashboardData } from "@/app/hooks/use-supabase-data";
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-green-800">
          Tableau de bord AgriSure
        </h1>
        <p className="text-muted-foreground">
          Votre assurance climatique intelligente - Dernière mise à jour :{" "}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-green-800">
                  Aucune catastrophe détectée
                </p>
                <p className="text-sm text-green-600">
                  Vos cultures sont actuellement protégées
                </p>
              </div>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {notifications.map((notification) => (
            <div
              key={notification.id}
              className={`flex items-center gap-3 p-3 rounded-lg ${notification.bg}`}
            >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-blue-800">
                  Plantez du sorgho (résistant à la sécheresse)
                </h3>
                <p className="text-sm text-blue-700 mt-1">
                  Adapté à faible humidité et températures élevées (32°C).
                  Rendement optimal dans les conditions actuelles.
                </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Probabilités basées sur les données météo et capteurs Irwise
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {riskData.map((item: RiskDataItem, index: number) => (
                  ...
                  >
                    ...
                    <td className="p-3 text-center">
                      <Badge variant={item.color}>{item.impact}</Badge>
                    </td>
                  </tr>
                ))}
              </tbody>
